...
classdef DriveBotSLAMSystem < minislam.slam.SLAMSystem
    ...
    methods(Access = protected)
        ...
        function handleGPSObservationEvent(this, event)
            ...
            % Refer to line 237 in DriveBotSimulator.m, set the
            % IF YOU ARE A RECRUITER WHO NEEDS TO RUN THIS CODE, PLEASE EMAIL ME AT
            % akshetp.ap@gmail.com
        ...
        function handleLandmarkObservationEvent(this, event)
            ...
            for l = 1 : length(event.landmarkIds)
                ...
                if (newVertexCreated==true)
                    %If it is a new landmark, compute it's location
        ...
        function deleteVehiclePredictionEdges(this)
            ...
            % Q3a:     
            % This function perfrom deleting vehicle prediction edges
            % This function loops through all process model edges and call
            % removeEdge function to remove it. If we are keeping the
            % first prediction edge (this.keepFirstPredictionEdge == true),
            % skip and retain the first process model edge
